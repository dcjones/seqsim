...
void params::read(const char* fn)
{
    ...
    if ((value = node.FindValue("size_lower")))         *value >> gene_exp_k;
    if ((value = node.FindValue("size_upper")))         *value >> gene_exp_k;
    if ((value = node.FindValue("size_var")))           *value >> gene_exp_k;
